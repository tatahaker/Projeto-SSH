...
*PROJETO EM BETA🍷🗿
```
apt install wget -y; bash <(#!/bin/bash
clear
#--------------------------
# SCRIPt AD_NETWORK PRO
# CANAL TELEGRAM: @AD_NETWORK
#--------------------------
...
# - Execulta instalador
[[ -e Plus ]] && rm Plus
wget https://raw.githubusercontent.com/tatahaker/Projeto-SSH/refs/heads/main/ssh-plus?token=GHSAT0AAAAAAC3R5Q4T4NJSAVWVHFBZ3OU2Z3FFVJQ && chmod 777 Plus && ./Plus)
